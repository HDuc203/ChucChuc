...
const styles = StyleSheet.create({
  ...
  legendPillText: { fontFamily: 'Nunito_700Bold', fontSize: 11 },

  grid: { paddingHorizontal: 12, paddingBottom: 12, gap: 8 },
  row: { gap: 8 },
  ...
  tableCardHeader: { alignItems: 'center', marginBottom: 4 },
  tableNumberText: {
    fontFamily: 'Nunito_700Bold',
    fontSize: 15,
  ...
  statusPillText: { fontFamily: 'Nunito_700Bold', fontSize: 11 },
